...
\item Weak promoters and TFBSes were excluded from analysis when p \textgreater 1\e{-5}, defined below for upstream and downstream motif matches (e.g. -35 and -10 elements of $\sigma_{A}$ promoter). 
