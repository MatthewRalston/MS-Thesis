...
\subcaption{\textit{sol} operon transcription initiation region. The distal (left) and proximal (right) transcription start sites (red) are shown for adhE1 (far right, orange).}\label{fig:5.11a}}
