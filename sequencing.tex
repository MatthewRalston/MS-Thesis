...
\subcaption{5' and 3' Untranslated Region Length}\label{fig:4.6a}
\end{center}
\end{minipage}%
\begin{minipage}{.5\textwidth}
\begin{center}
{\includegraphics[width=\linewidth,height=3in]{images/Sequencing/Cumulative_depth_boxplot.png}}
\subcaption{Cumulative Depth Distribution}\label{fig:4.6b}
\end{center}
\end{minipage}
\end{center}
\caption{Coverage Boxplots}
The distribution of coverage throughout the genome from a single library \subref{fig:4.6a}) is compared to cumulative coverage \subref{fig:4.6b}), showing high depth has been achieved.
\end{figure}
